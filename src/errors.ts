 ...
 */
export const authError = (message: string, context?: Record<string, any>): McpError => {
 ...
 * Create API error
 */
export const apiError = (message: string, context?: Record<string, any>): McpError => {
 ...
 */
export const validationError = (message: string, context?: Record<string, any>): McpError => {
 ...
 */
export const processingError = (message: string, context?: Record<string, any>): McpError => {
